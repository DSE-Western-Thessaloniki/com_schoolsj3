...
<form action="<?php echo Route::_('index.php?option=com_schoolsj3&view=units'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped" id="Schoolsj3List">
		...
		<?php foreach ($this->items as $i => $item) : 
			...
			<td class="center">
			    <?php echo HTMLHelper::_('jgrid.published', $item->published, $i, 'units.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
			</td>
			<td class="wrap has-context">
			    <a href="<?php echo Route::_('index.php?option=com_schoolsj3&task=unit.edit&id='.(int) $item->id); ?>">
