...
class MunicipalityModel extends AdminModel
{
    ...
    public function getTable($name = "Municipality", $prefix = "", $config = [])
    {
        if (
    ...
    {
        $form = $this->loadForm("com_schoolsj3.municipality", "municipality", [
            "control" => "jform",
            "load_data" => $loadData,
        ]);
    ...
    protected function loadFormData()
    {
        $data = Factory::getApplication()->getUserState(
            "com_schoolsj3.edit.municipality.data",
            []
        );
