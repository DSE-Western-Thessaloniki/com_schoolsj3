...
class DistrictModel extends AdminModel
{
    protected $text_prefix = 'COM_SCHOOLSJ3';

    public function getTable($name = 'District', $prefix = '', $config = array())
    {
    ...
    {
		$data = Factory::getApplication()->getUserState('com_schoolsj3.edit.district.data', array());
