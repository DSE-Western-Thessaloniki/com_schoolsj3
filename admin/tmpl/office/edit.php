...
<form action="<?php echo Route::_('index.php?option=com_schoolsj3&view=office&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
    <div class="row-fluid">
	<div class="span10 form-horizontal">
		...
		<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab',
		    ...
		    <?php echo HTMLHelper::_('uitab.addTab', 'myTab',
			    ...
			    Text::sprintf('COM_SCHOOLSJ3_EDIT_OFFICE',
				$this->item->id, true)); ?>
