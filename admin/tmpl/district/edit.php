...
<form action="<?php echo Route::_('index.php?option=com_schoolsj3&view=district&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
    <div class="row-fluid">
