...
<form action="<?php echo Route::_('index.php?option=com_schoolsj3&view=municipalities'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="filter-bar" class="btn-toolbar">
		...
		<label for="filter_search" class="element-invisible"><?php echo Text::_('COM_SCHOOLSJ3_SEARCH_IN_TITLE');?></label>
	...
	<table class="table table-striped" id="Schoolsj3List">
		...
		<?php foreach ($this->items as $i => $item) : 
			...
			<td class="center">
			    <?php echo HTMLHelper::_('jgrid.published', $item->published, $i, 'municipalities.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
			</td>
			<td class="wrap has-context">
			    <a href="<?php echo Route::_('index.php?option=com_schoolsj3&task=municipality.edit&id='.(int) $item->id); ?>">
