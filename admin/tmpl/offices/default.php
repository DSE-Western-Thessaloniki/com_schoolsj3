...
<form action="<?php echo Route::_('index.php?option=com_schoolsj3&view=offices'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped" id="Schoolsj3List">
		...
		<?php foreach ($this->items as $i => $item) : 
			...
			<td class="wrap has-context">
			    <a href="<?php echo Route::_('index.php?option=com_schoolsj3&task=office.edit&id='.(int) $item->id); ?>">
