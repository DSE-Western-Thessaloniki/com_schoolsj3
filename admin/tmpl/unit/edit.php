...
<form action="<?php echo Route::_('index.php?option=com_schoolsj3&view=unit&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
    <div class="row-fluid">
	<div class="span10 form-horizontal">
		...
		<?php echo HTMLHelper::_('bootstrap.startPane', 'myTab',
		    ...
		    <?php echo HTMLHelper::_('bootstrap.addPanel', 'myTab',
			    ...
			    Text::_('COM_SCHOOLSJ3_NEW_UNIT', true) :
			    Text::sprintf('COM_SCHOOLSJ3_EDIT_UNIT',
				$this->item->id, true)); ?>
