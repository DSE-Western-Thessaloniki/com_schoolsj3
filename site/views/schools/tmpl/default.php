...
<form action="<?php echo JRoute::_('index.php?option=com_schoolsj3&view=schools'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="filter-bar" class="btn-toolbar">
		...
		<button class="btn" type="button" onclick="window.location.href='index.php?option=com_schoolsj3&view=map'"><?php echo JText::_('COM_SCHOOLSJ3_SHOW_MAP')?></button>
	    </div>
	</div>
	...
	<table class="table table-striped" id="Schoolsj3List">
		...
		<?php foreach ($this->items as $i => $item) : ?>
			...
			<td class="wrap has-context">
			    <a href="<?php echo JRoute::_('index.php?option=com_schoolsj3&view=school&id='.(int) $item->id); ?>">
