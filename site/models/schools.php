...
class Schoolsj3ModelSchools extends JModelList
{
	...
	$query->select(
	    $this->getState(
		'list.select',
		'a.id, a.description AS schoolname, cat.description AS category, off.description AS office, mun.description AS municipality, shi.description AS shift, uni.units, dis.description AS district, a.published'
